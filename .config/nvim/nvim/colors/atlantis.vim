...
let g:atlantis_italics_enabled = get(g:, 'atlantis_italics_enabled', 0)
...
call s:HL('Normal', s:white1, '#101417', 'none')
...
"call s:HL('elixirTupleDelimiter', s:yellow1, 'none', 'none')
"call s:HL('elixirStructDelimiter', s:yellow1, 'none', 'none')
